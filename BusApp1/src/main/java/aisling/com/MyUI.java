...
public class MyUI extends UI {
    ...
    protected void init(VaadinRequest vaadinRequest) {
        ...
        String connectionString = "jdbc:sqlserver://tuesserver.database.windows.net:1433;" + "database=BusDatabase;"
                + "user=aislingstudent@tuesserver;" + "password=Server123;" + "encrypt=true;"
        ...
        myGrid.addColumn(Bus::getIsAccessibe).setCaption("Acessible");
